    ...
    <div align="center">
        ...
        <div class="table-responsive">
            <table class="table table-hover">
                ...
                <tbody>
                <c:forEach var="user" items="${projectList}" varStatus="status">

                    <tr>
                        <td>${status.index+1}</td>
                        <td>${user.projName}</td>
                        <td>${user.projDescription}</td>
                        <td>${user.projStatus}</td>
                        <td>${user.projPriority}</td>
                        <td>${user.projDatestarted}</td>
                        <td>${user.projDateend}</td>
                        <td>${user.projPrice}</td>
                        <td><a href="edit?id=${user.idProjects}" class="btn btn-primary btn-sm"><span
                                class="glyphicon glyphicon-edit"></span> Edit</a>
                            <a href="/projects/delete?id=${user.idProjects}" class="btn btn-danger btn-sm"><span
